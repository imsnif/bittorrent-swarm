...
Peer.prototype.onConnect = function () {
  ...
  wire.once('handshake', function (infoHashBuffer, peerId) {
    self.onHandshake(infoHashBuffer, peerId)
  })
 ...
 */
Peer.prototype.onHandshake = function (infoHashBuffer, peerId) {
  var self = this
...
Peer.prototype.handshake = function () {
  var self = this
  self.wire.handshake(self.swarm.infoHashBuffer, self.swarm.peerId, self.swarm.handshakeOpts)
